    ...
    <section className="relative py-20 px-4">
      <div className="max-w-3xl mx-auto space-y-20">
        <div className="animate-fade-in-up">
            ...
            <p className="mt-12 text-gray-400">Official Advisory/ Circular Link :</p>
            ...
            <div className="space-y-10">
                ...
                <p className="mt-3 text-gray-400">The process is very simple and easy, Your details will be validated shortly and Our team will provision your order.</p>
                <div className="flex">
                    <p className="text-gray-400"><span className="text-white">Note :</span> In case of international customers we will ask to upload Passport / other Government approved documents to validate customer details. In addition, Selfie with uploaded documents is mandatory.</p>
                </div>
            </div>
