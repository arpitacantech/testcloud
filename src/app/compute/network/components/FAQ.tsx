...
const faqs = [
  {
    ...
    answer:
      "Cloud networking refers to managing network resources such as private networks, routing, firewalls, and load balancing through software and APIs to connect, secure, and optimize traffic in cloud environments.",
    // meta: "Discovery",
  },
  {
 
  question: "What are cloud network services?",
  answer: 
    "Cloud network services are software-defined networking solutions that include private networks, routing, firewalls, load balancing, and security, delivered as part of modern cloud platforms to securely connect applications and users.",
  
},
  {
    question: "Is cloud networking available as a service?",
    answer:
      "Yes. Cantech provides cloud network as a service, allowing businesses to deploy, manage, and scale networking components on demand without managing physical infrastructure.",
    // meta: "Systems",
  },
  {
    question: "Can I customize my network configuration?",
    answer:
      "Yes. Cantech’s networking allows you to define your own subnets, IP ranges, routing policies, security rules, and more.",
    // meta: "Quality",
  },
   {
    question: "Do you support IPv6?",
    answer:
      "Yes. We provide both IPv4 and IPv6 support as part of our networking services.",
    // meta: "Quality",
  },
  {
    question: "Is DDoS protection included?",
    answer:
      " Built-in protection helps safeguard your workloads from common network attacks and traffic spikes.",
    // meta: "Quality",
  },
  {
    question: "How is network as a service used in cloud computing?",
    answer:
      "Network as a service in cloud computing enables organizations to consume networking capabilities, such as VPCs, firewalls, and load balancers through APIs and dashboards, improving agility and reducing operational overhead.",
    // meta: "Quality",
  },
  {
    question: "Why choose Cantech over other cloud network service providers?",
    answer:
      "Cantech combines enterprise-grade security, Indian data center presence, scalable architecture, and transparent pricing, making it one of the best networking services for cloud protection for enterprises.",
    // meta: "Quality",
  },
  {
    question: "What are the best networking services for cloud protection for enterprises?",
    answer:
      "The best networking services for cloud protection for enterprises offer built-in security, high availability, and scalable cloud networking. Cantech Cloud delivers enterprise-grade protection through secure VPCs, virtual firewalls, load balancing, and resilient cloud network services, making it one of the best networking service providers.",
    // meta: "Quality",
  },
];
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className={`relative flex w-full flex-col px-8 py-7 text-left transition-all duration-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[var(--faq-outline)]
                    ${open ? "items-start" : "items-start"}
                  `}
                >
                  {/* Header row */}
                  <div className="flex items-start justify-between gap-4 w-full">
                    <h3 className="cc-h3 faq-title">{item.question}</h3>
