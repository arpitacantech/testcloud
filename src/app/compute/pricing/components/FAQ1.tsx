...
const faqs = [
  {
    question: "What resources does Cantech Cloud Compute Pricing include?",
    answer:
      "All Cantech Cloud costs are based on usage not allocation - meaning you pay for resources consumed, and not for requesting that resources are made available to you (how it works elsewhere).",
    // meta: "Discovery",
  },
  {
    question: "What operating systems are supported?",
    answer:
      "Cantech Cloud compute supports Linux distributions which includes Ubuntu, Debian, CentOS and Windows.",
    // meta: "Collaboration",
  },
  {
    question: "Is backup included in Cantech cloud compute prices?",
    answer:
      "Yes. Automated backup services are included to secure your workloads without any manual intervention.",
    // meta: "Systems",
  },
  {
    question: "Are all these features included in usage based pricing?",
    answer:
      "Yes. All features are offered with transparent, usage based billing that comes with no hidden costs.",
    // meta: "Quality",
  },
   {
    question: "Can I include or remove services as needed?",
    answer:
      "Yes. Services such as VPN, backups and load balancers can be included or removed based on workload requirements.",
    // meta: "Quality",
  },
];
