    ...
    <div className="min-h-screen relative overflow-hidden">
      <div className="absolute inset-0 bg-black">
        ...
        <div className="absolute inset-0">
          <svg className="absolute inset-0 w-full h-full filter grayscale" viewBox="0 0 1200 800" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
            <defs>
